...
const Navbar = () => {
  ...
  return (
    <nav className="px-4 bg-gradient-to-r from-blue-500 to-indigo-500  flex items-center justify-between shadow-lg relative z-50">
      <Link to="/profile">
        {/* <img
          src={logo}
          className=" h-16 w-56 m-2 p-2 cursor-pointer"
          alt="Logo"
        /> */}
        <h1 className="text-white font-style: italic text-xl font-bold m-4 p-2 cursor-pointer">
          HCM❤️
        </h1>
      </Link>
